...
public class ViewCurrentBooking extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_view_current_booking);
        ...
        Button backBtn = findViewById(R.id.btn_back_currentbooking);
