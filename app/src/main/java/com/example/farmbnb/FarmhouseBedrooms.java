...
public class FarmhouseBedrooms extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_farmhouse_bedrooms);
        ...
        Button backBtn = findViewById(R.id.btn_back_fmhouse);
